...
const useSendMessage = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$19_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useSendMessage.useMutation": async ({ chatId, content })=>{
                const userMessage = {
                ...
                queryClient.setQueryData([
                    ...
                    "useSendMessage.useMutation": (old = [])=>{
                        return old.map({
                            "useSendMessage.useMutation": (chat)=>{
                                if (chat.id === chatId) {
                                    return {
                                        ...chat,
                                        messages: [
                                        ...
                                        if (chat.id === chatId) {
                                            return {
                                                ...
                                                messages: chat.messages.map({
                                                    "useSendMessage.useMutation": (m)=>m.id === assistantMessageId ? {
                                                            ...m,
...
const NewChatButton = ()=>{
    _s();
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateChat"])();
...
_s(NewChatButton, "MW4UITdo7NxcbX1Vwd8sBDJwGkE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateChat"],
...
const ChatList = ()=>{
    _s1();
    const { data: chats } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetChats"])();
...
_s1(ChatList, "c377L/o1Ofi82BrtOcQxO6ezAXk=", false, function() {
    return [
...
//# sourceMappingURL=_e993c2b4._.js.map