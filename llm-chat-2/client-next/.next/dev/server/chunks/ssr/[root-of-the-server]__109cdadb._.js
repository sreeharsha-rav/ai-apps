            ...
            if (role === "user") {
                setTimeout(()=>{
                    const aiMessage = {
                        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$uuid$40$13$2e$0$2e$0$2f$node_modules$2f$uuid$2f$dist$2d$node$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])(),
                        role: "assistant",
                        content: `This is a mock response to: "${content}". I am your AI assistant specialized in e-commerce!`,
                        timestamp: new Date()
                    };
                    set((state)=>({
                            chats: state.chats.map((chat)=>chat.id === chatId ? {
            ...
            messages: [
                {
                    id: "1",
                    role: "user",
                    content: "How do I use Shadcn?",
                    timestamp: new Date()
                },
                {
                    id: "2",
                    role: "assistant",
                    content: "You can use shadcn by running the npx command...",
                    timestamp: new Date()
                }
            ],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__109cdadb._.js.map