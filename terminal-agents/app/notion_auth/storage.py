...
from app.notion_auth.models import StoredTokens, TokenResponse
from app.config.settings import NOTION_TOKEN_STORAGE_FILE

STORAGE_FILE = NOTION_TOKEN_STORAGE_FILE
